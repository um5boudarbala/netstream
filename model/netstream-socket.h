/************************************************************************
 ** This file is part of the network simulator Ns3.                  **
...
// Get Storage
	...
	#include "netstream-storage.h"
     ...
     extern "C" void init_tcpip( ns3::SimulationController& );
#endif
...
namespace ns3
{
	...
	public:
		...
		{
			what_ = what;
			std::cerr << "ns3::NetStreamSocketException: " << what << std::endl << std::flush;
		}
